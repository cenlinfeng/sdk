...
public class MainActivity extends Activity implements JSInterface.H5PayListener, H5JSInterface {

    private ImageView img;
    //TODO 记得改包名
    //安卓配置
    private static int appid = 9; //平台
    private static String appkey = "b82c6380db9997a72e23055f9bc330f6";
...
//      mWebview = (WebView) findViewById(R.id.webview);
    ...
    private void doSDKLogin() {
        KLSDK.getInstance().login(MainActivity.this, appid, appkey, new IDdtListener<LoginMessageInfo>() {
            ...
            public void onLoadH5Url(String dologin_h5, String h5url) {
                Log.e("H5", "得到h5url字段"+h5url);
                if (!TextUtils.isEmpty(h5url)) {
                    mH5WebFragment.setJsInterface(MainActivity.this, "android");
                    Log.i("h5url", "onLoadH5Url: "+ h5url);
                    loadUrl(h5url);
                } else {
                    GetH5UrlFromService.getFinalUrl(dologin_h5, mUrlBack, MainActivity.this);
                }
            }
            ...
            public void onSuccess(LoginMessageInfo data) {
                ...
                if (data != null) {
                    ...
                    Log.e("H5（拿到dologin_h5）", "登录结果:" + result + "|msg" + msg
        ...
        MainActivity.this.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (mH5WebFragment != null) {
                    Log.e("H5:", "准备加载新势力："+url);
                    mLoadingDialog.show();
                    h5url = url;
                    mH5WebFragment.loadUrl(url);
                } else {
                    Log.e("H5:", "mH5WebFragment is null");
                }
            }
        });
    }
    ...
    private void h5Pay(String json) {
        ...
        if (isEmpty(dataBean.getUserid() + "") || isEmpty(dataBean.getOrderid()) ||
            ...
            KLSDK.getInstance().payment(MainActivity.this, paymentInfo, new ApiListenerInfo() {
                @Override
