...
public class KLFirstLoginActivity extends BaseActivity implements OnLimitClickListener {
    ...
    public static void startThisActivity(Activity activity) {
        Intent intent = new Intent(activity, KLFirstLoginActivity.class);
    ...
    protected String layoutName() {
        return Constants.login_main_first;
    }
    ...
    protected void initView() {
        ...
        if (AppConstants.login_config == 1) {
            kl_register_phone.setText("快速游戏");
        } else {
        ...
        kl_register_phone.setCompoundDrawablesWithIntrinsicBounds(null, ImageUtils.tintDrawable(this, "kl_icon_login_quick", AppConstants.colorPrimary), null, null);
        kl_more_game.setCompoundDrawablesWithIntrinsicBounds(null, ImageUtils.tintDrawable(this, "kl_icon_more_game", AppConstants.colorPrimary), null, null);
    }
...
//		AppConstants.ddt_ver_id = Utils.getAgent(KLFirstLoginActivity.this);
    }

    @Override
    public void onClick(View v) {
        if (v.getId() == AppConfig.resourceId(this, "kl_register_phone", "id")) {
            KLFirstQuickLoginActivity.startThisActivity(this);
            finish();
        }
    }
