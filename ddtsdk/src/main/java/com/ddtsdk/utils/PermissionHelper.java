...
public class PermissionHelper {
    ...
    public void requestPermissions(Context context){
        ...
        if(deniedPermissions != null && deniedPermissions.length > 0){
            ...
            mPermissionInterface.requestPermissionsSuccess(context);
        }
    }
     ...
     */
    public boolean requestPermissionsResult(Context context,int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults){
        if(requestCode == mPermissionInterface.getPermissionsRequestCode()){
            ...
            if(isAllGranted){
                ...
                //权限有缺失
                mPermissionInterface.requestPermissionsFail(context);
            }
            return true;
        }
        return false;
