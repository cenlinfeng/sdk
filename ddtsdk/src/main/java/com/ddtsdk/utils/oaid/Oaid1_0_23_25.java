...
/**
 * 适用oaid 1.0.23  1.0.25版本
 * 1.0.25版本需要设置minSdkVersion不低于21
 */
public class Oaid1_0_23_25 extends AbstractOaid {

    public final static String LISTENER_CLASS = "com.bun.miitmdid.interfaces.IIdentifierListener";
    public final static String MDID_HELPER = "com.bun.miitmdid.core.MdidSdkHelper";

    public Oaid1_0_23_25(Context context,  AppIdsUpdater listener, ClassLoader classLoader) {
    ...
    private int DirectCall() {
        ...
        if (listenerClazz == null) {
         ...
         LogUtil.i("oaid listener name: " + listenerClazz.getName());
        ...
        if (mdidSdkHelperClass == null) {
         ...
         LogUtil.i("oaid helper name: " + mdidSdkHelperClass.getName());
